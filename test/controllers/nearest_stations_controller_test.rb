...
class NearestStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nearest_station" do
    assert_difference('NearestStation.count') do
      post nearest_stations_url, params: { nearest_station: { duration: @nearest_station.duration, line: @nearest_station.line, station: @nearest_station.station } }
    end
  ...
  test "should update nearest_station" do
    patch nearest_station_url(@nearest_station), params: { nearest_station: { duration: @nearest_station.duration, line: @nearest_station.line, station: @nearest_station.station } }
